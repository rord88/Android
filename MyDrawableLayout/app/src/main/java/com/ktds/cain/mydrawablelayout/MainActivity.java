...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Toast.makeText(MainActivity.this, "카메라 선택완료", Toast.LENGTH_SHORT).show();
            transaction.replace(R.id.container, cameraFragment);
        } else if (id == R.id.nav_gallery) {
            Toast.makeText(MainActivity.this, "갤러리 선택완료", Toast.LENGTH_SHORT).show();
            transaction.replace(R.id.container, gallaryFragment);
